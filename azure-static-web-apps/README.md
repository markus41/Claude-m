...
### Azure Static Web Apps — JAMstack/SPA hosting with built-in auth, API backends, PR preview environments, and staticwebapp.config.json management
...
<sub><code>microsoft</code> &nbsp;·&nbsp; <code>azure</code> &nbsp;·&nbsp; <code>static-web-apps</code> &nbsp;·&nbsp; <code>jamstack</code> &nbsp;·&nbsp; <code>spa</code> &nbsp;·&nbsp; <code>serverless</code></sub>
...
> [!TIP]
> **One-line install** — `/plugin install azure-static-web-apps@claude-m-microsoft-marketplace`
...
| Component | Items |
|---|---|
| **Commands** | `/swa-api-deploy` · `/swa-auth-configure` · `/swa-config` · `/swa-create` · `/swa-setup` |
| **Agents** | `swa-reviewer` |
| **Skills** | `azure-static-web-apps` |
...
```text
Use azure-static-web-apps to audit and operate Azure resources end-to-end.
```
...
flowchart LR
    ...
    U["You"]:::user
    CC["Claude Code"]:::cc
    PG["azure-static-web-apps<br/>(plugin)"]:::plugin
...
/plugin install azure-static-web-apps@claude-m-microsoft-marketplace
```
...
<details>
<summary><b>Composable stacks that include <code>azure-static-web-apps</code></b></summary>
