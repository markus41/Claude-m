...
<sub><code>azure</code> &nbsp;·&nbsp; <code>service</code> &nbsp;·&nbsp; <code>health</code></sub>
...
> [!TIP]
> **One-line install** — `/plugin install azure-service-health@claude-m-microsoft-marketplace`
...
| Component | Items |
|---|---|
| **Commands** | `/service-health-comms-summary` · `/service-health-impact-score` · `/service-health-runbook-map` · `/service-health-setup` · `/service-health-watchlist` |
| **Agents** | `azure-service-health-reviewer` |
| **Skills** | `azure-service-health` |
...
```text
Use azure-service-health to audit and operate Azure resources end-to-end.
```
...
flowchart LR
    ...
    U["You"]:::user
    CC["Claude Code"]:::cc
    PG["azure-service-health<br/>(plugin)"]:::plugin
...
<tr><td><a href="../azure-service-bus/README.md"><code>azure-service-bus</code></a></td><td>Azure messaging operations for Service Bus and event-driven workloads - lag scans, dead-letter replay planning, stale subscription cleanup, and namespace quota checks.</td></tr>
...
<details>
<summary><b>Composable stacks that include <code>azure-service-health</code></b></summary>
