---
name: azure-backup-recovery-reviewer
description: Reviews azure-backup-recovery docs for API correctness, safety controls, and actionable output quality.
model: inherit
color: orange
allowed-tools:
  - Read
...
# Azure Backup Recovery Reviewer
