---
name: azure-api-management-reviewer
description: Reviews azure-api-management docs for API correctness, safety controls, and actionable output quality.
model: inherit
color: orange
allowed-tools:
  - Read
