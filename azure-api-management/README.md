...
<sub><code>azure</code> &nbsp;·&nbsp; <code>api</code> &nbsp;·&nbsp; <code>management</code></sub>
...
> [!TIP]
> **One-line install** — `/plugin install azure-api-management@claude-m-microsoft-marketplace`
...
| Component | Items |
|---|---|
| **Commands** | `/apim-api-inventory` · `/apim-contract-diff` · `/apim-policy-drift` · `/apim-secret-rotation` · `/apim-setup` |
| **Agents** | `azure-api-management-reviewer` |
...
```text
Use azure-api-management to audit and operate Azure resources end-to-end.
```
...
flowchart LR
    ...
    U["You"]:::user
    CC["Claude Code"]:::cc
    PG["azure-api-management<br/>(plugin)"]:::plugin
...
<details>
<summary><b>Composable stacks that include <code>azure-api-management</code></b></summary>
