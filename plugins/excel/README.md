...
### Read and update workbooks, worksheets, ranges, and tables via MCP.
...
<sub><code>microsoft</code> &nbsp;·&nbsp; <code>excel</code> &nbsp;·&nbsp; <code>data</code></sub>
...
> [!TIP]
> **One-line install** — `/plugin install microsoft-excel-mcp@claude-m-microsoft-marketplace`
...
```text
Use microsoft-excel-mcp to automate Microsoft 365 collaboration workflows.
```
...
flowchart LR
    ...
    U["You"]:::user
    CC["Claude Code"]:::cc
    PG["microsoft-excel-mcp<br/>(plugin)"]:::plugin
...
/plugin install microsoft-excel-mcp@claude-m-microsoft-marketplace
```
...
<details>
<summary><b>Composable stacks that include <code>microsoft-excel-mcp</code></b></summary>
