...
### Microsoft Fabric Data Warehouse — Synapse warehouses, T-SQL DDL/DML, cross-database queries, stored procedures, and data modeling
...
<sub><code>microsoft</code> &nbsp;·&nbsp; <code>fabric</code> &nbsp;·&nbsp; <code>data-warehouse</code> &nbsp;·&nbsp; <code>synapse</code> &nbsp;·&nbsp; <code>t-sql</code> &nbsp;·&nbsp; <code>warehouse</code></sub>
...
> [!TIP]
> **One-line install** — `/plugin install fabric-data-warehouse@claude-m-microsoft-marketplace`
...
| Component | Items |
|---|---|
| **Commands** | `/sample-warehouse-bootstrap` · `/warehouse-create` · `/warehouse-load` · `/warehouse-monitor` · `/warehouse-query` · `/warehouse-setup` · `/warehouse-table-create` |
| **Agents** | `warehouse-reviewer` |
| **Skills** | `fabric-data-warehouse` |
...
```text
Use fabric-data-warehouse to design, build, and govern Fabric / Power BI assets.
```
...
flowchart LR
    ...
    U["You"]:::user
    CC["Claude Code"]:::cc
    PG["fabric-data-warehouse<br/>(plugin)"]:::plugin
...
/plugin install fabric-data-warehouse@claude-m-microsoft-marketplace
```
...
<details>
<summary><b>Composable stacks that include <code>fabric-data-warehouse</code></b></summary>
