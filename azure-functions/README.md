...
### Azure Functions — triggers, bindings, Durable Functions, deployment, and local development with Azure Functions Core Tools
...
<sub><code>microsoft</code> &nbsp;·&nbsp; <code>azure</code> &nbsp;·&nbsp; <code>functions</code> &nbsp;·&nbsp; <code>serverless</code> &nbsp;·&nbsp; <code>durable-functions</code> &nbsp;·&nbsp; <code>triggers</code></sub>
...
> [!TIP]
> **One-line install** — `/plugin install azure-functions@claude-m-microsoft-marketplace`
...
| Component | Items |
|---|---|
| **Commands** | `/func-binding-config` · `/func-create` · `/func-deploy` · `/func-durable` · `/func-setup` · `/func-trigger-add` |
| **Agents** | `functions-reviewer` |
...
```text
Use azure-functions to audit and operate Azure resources end-to-end.
```
...
flowchart LR
    ...
    U["You"]:::user
    CC["Claude Code"]:::cc
    PG["azure-functions<br/>(plugin)"]:::plugin
...
/plugin install azure-functions@claude-m-microsoft-marketplace
```
...
<tr><td><a href="../azure-static-web-apps/README.md"><code>azure-static-web-apps</code></a></td><td>Azure Static Web Apps — JAMstack/SPA hosting with built-in auth, API backends, PR preview environments, and staticwebapp.config.json management</td></tr>
...
<details>
<summary><b>Composable stacks that include <code>azure-functions</code></b></summary>
