---
name: microsoft-intune-reviewer
description: Reviews microsoft-intune docs for API correctness, safety controls, and actionable output quality.
model: inherit
color: orange
allowed-tools:
  - Read
