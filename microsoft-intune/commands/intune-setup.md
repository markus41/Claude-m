---
name: intune-setup
description: Execute the intune setup workflow with deterministic validation and redacted output.
...
Run the intune setup workflow for microsoft-intune.
...
|---|---|---|
| Primary workflow query | GET | `/intune-setup` |
