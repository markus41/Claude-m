...
### Azure App Service — create, deploy, and manage web apps, deployment slots, custom domains, and TLS certificates via ARM REST API
...
<sub><code>microsoft</code> &nbsp;·&nbsp; <code>azure</code> &nbsp;·&nbsp; <code>app-service</code> &nbsp;·&nbsp; <code>web-apps</code> &nbsp;·&nbsp; <code>deployment</code> &nbsp;·&nbsp; <code>paas</code></sub>
...
> [!TIP]
> **One-line install** — `/plugin install azure-web-apps@claude-m-microsoft-marketplace`
...
| Component | Items |
|---|---|
| **Commands** | `/webapp-config` · `/webapp-create` · `/webapp-deploy` · `/webapp-setup` · `/webapp-slots` |
| **Agents** | `webapp-reviewer` |
| **Skills** | `azure-web-apps` |
...
```text
Use azure-web-apps to audit and operate Azure resources end-to-end.
```
...
flowchart LR
    ...
    U["You"]:::user
    CC["Claude Code"]:::cc
    PG["azure-web-apps<br/>(plugin)"]:::plugin
...
/plugin install azure-web-apps@claude-m-microsoft-marketplace
```
...
<details>
<summary><b>Composable stacks that include <code>azure-web-apps</code></b></summary>
