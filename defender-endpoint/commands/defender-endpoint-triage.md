...
description: Execute the defender endpoint triage workflow with deterministic validation and redacted output.
...
Run the defender endpoint triage workflow for defender-endpoint.
...
|---|---|---|
| Primary workflow query | GET | `/defender-endpoint-triage` |
