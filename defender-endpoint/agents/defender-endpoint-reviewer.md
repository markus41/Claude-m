---
name: defender-endpoint-reviewer
description: Reviews defender-endpoint docs for API correctness, safety controls, and actionable output quality.
model: inherit
color: orange
allowed-tools:
  - Read
