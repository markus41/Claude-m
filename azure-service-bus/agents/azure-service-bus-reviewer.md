---
name: azure-service-bus-reviewer
description: Reviews azure-service-bus docs for API correctness, safety controls, and actionable output quality.
model: inherit
color: orange
allowed-tools:
  - Read
