---
name: entra-access-reviews-reviewer
description: Reviews entra-access-reviews docs for API correctness, safety controls, and actionable output quality.
model: inherit
color: orange
allowed-tools:
  - Read
